package net.ragdot.featherfall;
...
import net.ragdot.featherfall.item.ModItems;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import java.util.List;

public class Featherfall implements ModInitializer {
    public static final String MOD_ID = "featherfall";
