...
public class ScorchedUtopiaModel extends SinglePartEntityModel<ScorchedUtopia> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData body_top = zombie_model.addChild("body_top", ModelPartBuilder.create(), ModelTransform.of(0.9594F, -18.7784F, -2.1892F, -0.6919F, -0.1695F, 0.3277F));

		ModelPartData body_up = body_top.addChild("body_up", ModelPartBuilder.create(), ModelTransform.of(-1.1615F, -5.0056F, 0.4605F, -0.1391F, 0.3384F, -0.3572F));
		...
		ModelPartData head = body_up.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-3.9796F, -4.814F, -1.148F, 8.0F, 7.0F, 8.0F, new Dilation(-0.002F))
				...
				.uv(0, 15).cuboid(-3.9535F, 1.7609F, -1.0815F, 8.0F, 1.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(-0.8807F, -7.7686F, -4.7079F, 0.0927F, 0.0012F, -0.2513F));
		...
		ModelPartData jaw_r1 = jaw.addChild("jaw_r1", ModelPartBuilder.create().uv(0, 17).cuboid(-4.0F, -0.7745F, -0.4488F, 8.0F, 3.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(-0.0378F, 0.2698F, -0.6771F, -1.1345F, 0.0F, 0.0F));
		...
		ModelPartData R_eye_r1 = front1.addChild("R_eye_r1", ModelPartBuilder.create().uv(48, 39).cuboid(-1.0F, -2.4641F, 0.0085F, 3.0F, 4.0958F, 0.0F, new Dilation(0.0F)), ModelTransform.of(-2.46F, -0.0961F, -0.3641F, 0.0873F, 0.0873F, 1.5708F));
		...
		ModelPartData cube_r1 = front2.addChild("cube_r1", ModelPartBuilder.create().uv(57, 39).cuboid(-1.1352F, -0.0223F, -0.1986F, 3.0F, 4.0996F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0044F, 0.8352F, -0.134F, 0.0873F, -0.3927F, 1.5708F));

		ModelPartData cube_r2 = front2.addChild("cube_r2", ModelPartBuilder.create().uv(57, 39).mirrored().cuboid(-1.8648F, -0.011F, -0.1909F, 3.0074F, 4.0035F, 0.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0044F, 0.8352F, -0.134F, 0.0873F, 0.3927F, -1.5708F));
		...
		ModelPartData cube_r7 = top1.addChild("cube_r7", ModelPartBuilder.create().uv(58, 39).cuboid(-0.8352F, -2.0223F, -0.1986F, 2.0F, 4.0996F, 0.0F, new Dilation(0.0F)), ModelTransform.of(-1.988F, 0.1333F, -0.5308F, 0.0873F, -0.3491F, 1.5708F));
		...
		ModelPartData cube_r19 = hair.addChild("cube_r19", ModelPartBuilder.create().uv(52, 35).cuboid(-4.2F, -2.3F, 2.0349F, 4.0F, 0.0F, 3.5651F, new Dilation(0.0F)), ModelTransform.of(6.7025F, 1.272F, 0.8447F, -0.4192F, 0.0076F, -0.0869F));
		...
		ModelPartData gear = body_u.addChild("gear", ModelPartBuilder.create().uv(46, 44).cuboid(-0.5F, -2.5F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(3.332F, -3.9954F, 5.4945F, 1.2337F, -1.1441F, -0.6993F));

		ModelPartData cube_r20 = gear.addChild("cube_r20", ModelPartBuilder.create().uv(46, 44).cuboid(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(-0.01F)), ModelTransform.of(1.2071F, -1.2071F, 0.0F, 3.1416F, 0.0F, -2.3562F));

		ModelPartData cube_r21 = gear.addChild("cube_r21", ModelPartBuilder.create().uv(46, 44).cuboid(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(-0.01F)), ModelTransform.of(1.2071F, 1.2071F, 0.0F, 3.1416F, 0.0F, -0.7854F));

		ModelPartData cube_r22 = gear.addChild("cube_r22", ModelPartBuilder.create().uv(46, 44).cuboid(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(-0.01F)), ModelTransform.of(-1.2071F, -1.2071F, 0.0F, 3.1416F, 0.0F, 2.3562F));

		ModelPartData cube_r23 = gear.addChild("cube_r23", ModelPartBuilder.create().uv(46, 44).cuboid(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(-0.01F)), ModelTransform.of(-1.2071F, 1.2071F, 0.0F, 3.1416F, 0.0F, 0.7854F));

		ModelPartData cube_r24 = gear.addChild("cube_r24", ModelPartBuilder.create().uv(46, 44).cuboid(-0.375F, -2.625F, -1.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.125F, -0.125F, 0.5F, 0.0F, 0.0F, 1.5708F));

		ModelPartData cube_r25 = gear.addChild("cube_r25", ModelPartBuilder.create().uv(46, 44).cuboid(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-1.5F, 0.0F, 0.0F, 3.1416F, 0.0F, 1.5708F));

		ModelPartData cube_r26 = gear.addChild("cube_r26", ModelPartBuilder.create().uv(46, 44).cuboid(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.5F, 0.0F, 3.1416F, 0.0F, 0.0F));
		...
		ModelPartData R_l_arm = R_arm.addChild("R_l_arm", ModelPartBuilder.create().uv(0, 32).cuboid(-1.138F, 0.4368F, -0.8956F, 2.0F, 7.0F, 2.0F, new Dilation(0.4F)), ModelTransform.of(-0.9596F, 8.0899F, 0.0748F, -0.0008F, 0.5923F, -0.1835F));

		ModelPartData R_hand = R_l_arm.addChild("R_hand", ModelPartBuilder.create(), ModelTransform.pivot(-0.0301F, 7.8418F, 4.405F));
		...
		ModelPartData L_l_arm = L_arm.addChild("L_l_arm", ModelPartBuilder.create().uv(8, 32).mirrored().cuboid(-0.9832F, -0.675F, -1.1289F, 2.0F, 7.0F, 2.0F, new Dilation(0.4F)).mirrored(false), ModelTransform.of(0.2928F, 7.5717F, -0.0294F, 0.068F, -0.1988F, 0.4585F));

		ModelPartData L_hand = L_l_arm.addChild("L_hand", ModelPartBuilder.create(), ModelTransform.pivot(0.1F, 7.5508F, 4.3268F));

		ModelPartData left_hand_r1 = L_hand.addChild("left_hand_r1", ModelPartBuilder.create().uv(26, 18).mirrored().cuboid(-1.6F, -1.1F, -0.1F, 3.0F, 3.0F, 2.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0269F, -0.0625F, -4.956F, 0.7854F, 0.0F, 0.0F));

		ModelPartData body_mid = body_top.addChild("body_mid", ModelPartBuilder.create().uv(40, 4).cuboid(-3.525F, -4.3163F, -2.1892F, 7.0F, 4.0F, 4.0F, new Dilation(0.3F)), ModelTransform.of(0.3557F, -0.2404F, 2.7746F, 0.2593F, 0.1604F, -0.2687F));

		ModelPartData body_bot = zombie_model.addChild("body_bot", ModelPartBuilder.create(), ModelTransform.of(0.7959F, -18.8174F, 0.1259F, 0.0095F, -0.0076F, -0.0864F));
		...
		ModelPartData R_leg = legs.addChild("R_leg", ModelPartBuilder.create(), ModelTransform.of(-2.387F, -1.0664F, -0.8733F, 0.0837F, -0.0081F, 0.0106F));

		ModelPartData R_u_leg = R_leg.addChild("R_u_leg", ModelPartBuilder.create().uv(0, 41).cuboid(-0.8772F, 0.1285F, -4.166F, 2.0F, 6.0F, 2.0F, new Dilation(0.5F)), ModelTransform.pivot(-0.4F, -0.9F, 3.0F));

		ModelPartData R_l_leg = R_leg.addChild("R_l_leg", ModelPartBuilder.create().uv(0, 49).cuboid(-0.7653F, -0.3933F, -0.8078F, 2.0F, 7.0F, 2.0F, new Dilation(0.3F)), ModelTransform.of(-0.351F, 5.1686F, 0.1619F, 1.0298F, 0.2469F, -0.1335F));

		ModelPartData L_leg = legs.addChild("L_leg", ModelPartBuilder.create(), ModelTransform.of(1.7095F, 0.8403F, -0.8428F, -0.0872F, -0.1124F, -0.1234F));
		...
		ModelPartData left_l_leg = L_leg.addChild("left_l_leg", ModelPartBuilder.create().uv(8, 49).mirrored().cuboid(-1.225F, -0.1589F, -1.05F, 2.0F, 7.0F, 2.0F, new Dilation(0.3F)).mirrored(false), ModelTransform.of(-0.4399F, 6.0174F, 2.9064F, 0.7828F, -0.1116F, 0.0174F));
	...
	public void setAngles(ScorchedUtopia entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.updateAnimation(entity.idleAnimationState, ScorchedUtopianimation.idle, ageInTicks, 1f);
		this.updateAnimation(entity.guardAnimationState, ScorchedUtopianimation.Gaurd, ageInTicks, 1f);
		this.updateAnimation(entity.throwAnimationState, ScorchedUtopianimation.Throw, ageInTicks, 1f);
		this.updateAnimation(entity.grabAnimationState, ScorchedUtopianimation.grab, ageInTicks, 1f);
	}
